package yaroslavgorbach.reaction.feature.exercise.result.ui
...
fun ExerciseResult(exerciseResultUi: ExerciseResultUi, onBackClick: () -> Unit, onRepeatExercise: (ExerciseName) -> Unit) {
    ...
    Column(Modifier.fillMaxSize()) {
        ...
        Row(
            ...
            Box {
                Text(text = "10%", modifier = Modifier.align(Center), textAlign = TextAlign.Center, fontSize = 12.sp)
                CircularProgressIndicator(progress = 1f, color = Color.Red.copy(alpha = 0.4f))
